...
[Contributor Code of Conduct](https://github.com/CarolinaBlanco/proyectorepro/blob/main/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report 
unacceptable behavior to <edna.blanco01@gmail.com>.
...
[Issues](https://github.com/CarolinaBlanco/proyectorepro/issues) that might help 
...
- Open a new [Issue](https://github.com/CarolinaBlanco/proyectorepro/issues/new).
- Use the template [other_issue.md](https://github.com/CarolinaBlanco/proyectorepro/blob/main/.github/ISSUE_TEMPLATE/other_issue.md).
...
for your bug or error in the [bug tracker](https://github.com/CarolinaBlanco/proyectorepro/issues?q=label%3Abug).



### How do I submit a bug report?

We use [GitHub Issues](https://github.com/CarolinaBlanco/proyectorepro/issues) to 
track bugs and errors. If you run into an issue with the project:

- Open a new [Issue](https://github.com/CarolinaBlanco/proyectorepro/issues/new).
- Use the template [bug_report.md](https://github.com/CarolinaBlanco/proyectorepro/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Make sure that you are using the latest version of `proyectorepro`.
- Read the [documentation](https://github.com/CarolinaBlanco/proyectorepro/)
carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/CarolinaBlanco/proyectorepro/issues) to 
...
[GitHub Issues](https://github.com/CarolinaBlanco/proyectorepro/issues).

- Open a new [Issue](https://github.com/CarolinaBlanco/proyectorepro/issues/new).
- Use the template [feature_request.md](https://github.com/CarolinaBlanco/proyectorepro/blob/main/.github/ISSUE_TEMPLATE/feature_request.md).
...
3. Submit a [Pull Request](https://docs.github.com/en/get-started/quickstart/contributing-to-projects#making-a-pull-request) on the [original repo](https://github.com/CarolinaBlanco/proyectorepro/compare).
